...
<nav x-data="{ open: false }" class=" border-b border-gray-100" style="background-color: #fff;">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="img/img-9.png" class="rounded mx-auto d-block" alt="">  
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="student">Recycling Product</a></li>
