    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a class="getstarted scrollto" href="#"><span>Registration</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="{{ route('register') }}">Registration as User</a></li>
              <li><a href="registration">Registration as Admin</a></li>
